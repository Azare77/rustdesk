...
class PlatformFFI {
  ...
  late BaradaranAssistantImpl _ffiBind;
  ...
  BaradaranAssistantImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = BaradaranAssistantImpl(dylib);
  ...
  void _startListenEvent(BaradaranAssistantImpl rustdeskImpl) {
    final appType =
