    ...
    return futureBuilder(future: () async {
      ...
      return DesktopScrollWrapper(
          ...
          child: SingleChildScrollView(
            controller: scrollController,
            physics: DraggableNeverScrollableScrollPhysics(),
            child: _Card(title: '${translate('About')} Baradaran Assistant', children: [
              Column(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://BaradaranAssistant.com/privacy.html');
                      },
                      child: Text(
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://baradaransoft.com');
                      },
                      child: Text(
                        translate('Website'),
                        style: linkStyle,
